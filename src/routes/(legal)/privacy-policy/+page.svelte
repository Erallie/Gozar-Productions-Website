...
<div class="content">
    ...
    <section>
        <p>
            ...
            collected and recorded by Gozar Productions and how we use it.
        </p>
        <p>
        ...
        <p>
            ...
            that they shared and/or collect in Gozar Productions. This policy is
    ...
    <section id="information-we-collect">
        ...
        <ul>
            <li>
                ...
                phone numbers; email addresses; first name and last name; current
                mailing and billing addresses; and other similar data.
            </li>
            <li>
                <strong>Personal Information Provided by You.</strong> We collect
                financial information (credit card number, purchase history, invoices);
            ...
            <li>
                ...
                payment data is stored by PayPal. You may find their privacy
                policy
                <a
            ...
            <li>
                ...
                to maintain the security and operation of our Services, and for our
    ...
    <section id="how-we-use-your-information">
        ...
        <ul>
            <li>
                <strong>To fulfill and manage your payments.</strong> We may use
            ...
            <li>
                ...
                by clicking on the unsubscribe link in the emails that we send or
    ...
    <section id="log-files">
        <h2>Log files</h2>
        <p>
            Gozar Productions follows a standard procedure of using log files.
    ...
    <section id="cookies-and-web-beacons">
        <h2>Cookies and web beacons</h2>
        <p>
            Like any other website, Gozar Productions uses 'cookies'. These
        ...
        <p>
            ...
            allow you to connect with your social networks in various ways. For
            these to work, these social media sites will set cookies through our
            ...
            their respective privacy policies. <strong
            ...
            > You can find the privacy policies of the social media plugins we use
            in our website here: Facebook's Privacy Policy.
        </p>
    </section>
    <section id="third-party-privacy-policies">
        <h2>Third party privacy policies</h2>
        <p>
            Gozar Productions's Privacy Policy does not apply to other
            advertisers or websites. Thus, we are advising you to consult the
            respective Privacy Policies of these third-party servers for more
            detailed information. It may include their practices and
            instructions about how to opt-out of certain options. View these
            Privacy Policies here: Wix's Privacy Policy and Google's Privacy
            Policy.
        </p>
    </section>
    <section id="ccpa-privacy-rights">
    ...
    <section id="gdpr-data-protection-rights">
    ...
    <section id="childrens-information">
        ...
        <p>
            Gozar Productions does not knowingly collect any Personal
...
<style>
    ...
    section {
        width: 100%;
        padding: 30px max(calc(50% - 400px), 5%);
    ...
    section:nth-child(odd) {
        background-color: rgba(59, 23, 23, 1);
        color: white;
    }
</style>

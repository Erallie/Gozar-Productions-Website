...
<p>
    At Gozar Productions, accessible from <a href="/">GozarProductions.com</a>,
    ...
    by Gozar Productions and how we use it.
</p>
<p>
...
<p>
    ...
    and/or collect in Gozar Productions. This policy is not applicable to any
...
<ul>
    <li>
        <strong>Publicly Available Personal Information.</strong> We collect phone
        numbers; email addresses; first name and last name; current mailing and billing
    ...
    <li>
        <strong>Payment Data.</strong> We collect data necessary to process your
        ...
        your payment instrument. All payment data is stored by PayPal. You may
    ...
    <li>
        ...
        certain information when you visit, use or navigate the Services. This information
        ...
        URLs, device name, country, location, information about how and when you
        ...
        internal analytics and reporting purposes. Like many businesses, we also
...
<ul>
    <li>
        <strong>To fulfill and manage your payments.</strong> We may use your information
    ...
    <li>
        ...
        may use your information to respond to your inquiries and solve any potential
        issues you might have with the use of our Services.
    </li>

    <li>
        <strong>To send you marketing and promotional communications.</strong> We
        may process the personal information you send to us for our marketing purposes,
        if this is in accordance with your marketing preferences. You can opt out
        of our marketing emails at any time by clicking on the unsubscribe link in
        the emails that we send or by contacting us directly.
    </li>
    ...
    <li>
        ...
        and improve our Services, products, marketing and your experience. We may
        use and store this information in aggregated and anonymized form so that
        it is not associated with individual end users and does not include personal
...
<ul>
    ...
    <li>
        ...
        such as in response to a court order or a subpoena (including in response
...
<p>
    Like any other website, Gozar Productions uses 'cookies'. These cookies are
...
<p>
    ...
    to connect with your social networks in various ways. For these to work,
    these social media sites will set cookies through our site which may be used
    to enhance your profile on their site or contribute to the data they hold
    for various purposes outlined in their respective privacy policies. <strong
        >THESE COOKIES MUST BE DISABLED WITHIN YOUR BROWSER SETTINGS SEPARATELY
        FROM OUR WEBSITE. DECLINING OUR COOKIES IN THE POP-UP DOES NOT DISABLE
        THEM.</strong
    > You can find the privacy policies of the social media plugins we use in our
    website here: Facebook's Privacy Policy.
</p>
<h2>THIRD PARTY PRIVACY POLICIES</h2>
<p>
    Gozar Productions's Privacy Policy does not apply to other advertisers or
    websites. Thus, we are advising you to consult the respective Privacy
    Policies of these third-party servers for more detailed information. It may
    include their practices and instructions about how to opt-out of certain
    options. View these Privacy Policies here: Wix's Privacy Policy and Google's
    Privacy Policy.
</p>

...
<LegalSection id="information-we-collect">
    ...
    <ul>
        <li>
            <strong>Publicly Available Personal Information.</strong> We collect
            phone numbers; email addresses; first name and last name; current mailing
            and billing addresses; and other similar data.
        </li>
        <li>
            <strong>Personal Information Provided by You.</strong> We collect financial
        ...
        <li>
            ...
            by PayPal. You may find their privacy policy
            <a
...
<LegalSection id="how-we-use-your-information">
    ...
    <ul>
        <li>
            <strong>To fulfill and manage your payments.</strong> We may use your
        ...
        <li>
            ...
            link in the emails that we send or by contacting us directly.
        </li>
        <li>
...
<LegalSection id="will-your-information-be-shared-with-anyone">
...
<LegalSection id="log-files">
    <h2>Log files</h2>
    <p>
        Gozar Productions follows a standard procedure of using log files. These
...
<LegalSection id="cookies-and-web-beacons">
    <h2>Cookies and web beacons</h2>
    <p>
        Like any other website, Gozar Productions uses 'cookies'. These cookies
    ...
    <p>
        ...
        policies. <strong
            >THESE COOKIES MUST BE DISABLED WITHIN YOUR BROWSER SETTINGS
            SEPARATELY FROM OUR WEBSITE. DECLINING OUR COOKIES IN THE POP-UP
            DOES NOT DISABLE THEM.</strong
        > You can find the privacy policies of the social media plugins we use in
        our website here: Facebook's Privacy Policy.
    </p>
</LegalSection>
<LegalSection id="third-party-privacy-policies">
    <h2>Third party privacy policies</h2>
    <p>
        Gozar Productions's Privacy Policy does not apply to other advertisers
...
<LegalSection id="ccpa-privacy-rights">
...
<LegalSection id="gdpr-data-protection-rights">
...
<LegalSection id="childrens-information">
    ...
    <p>
        Gozar Productions does not knowingly collect any Personal Identifiable
